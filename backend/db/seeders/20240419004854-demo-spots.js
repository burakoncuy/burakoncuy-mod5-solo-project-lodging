    ...
    await Spot.bulkCreate([
      {
        ...
        lat: 37.7645358,
        lng: -122.4730327,
        name: "Star City: Nearby Attractions and Cozy Getaway",
        description: "A rainy getaway for those that love hiking",
        price: 215,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ownerId: 2,
        address: "343 Peach Lane, Suite 22A",
        city: "Brooklyn",
        state: "NY",
        country: "United States of America",
        lat: 37.832492,
        ...
        description: "Modern urban flat with city views, modern art, WiFi, and free parking.",
        price: 325,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        description: "Modern house with amazing views. Cat not included.",
        price: 385,
        createdAt: new Date(),
        updatedAt: new Date()
      },
